...
var StereoCamera = THREE.StereoCamera;
...
/*import {
 ...
 const SideBySideStereoEffect = function(renderer, strenderer, cross, squeeze, tab) {
 ...
 const InterleavedStereoEffect = function (renderer, strenderer, dir) {
 ...
 const MirroredStereoEffect = function (renderer, strenderer, dir) {
	const _material = new ShaderMaterial({
		uniforms: {
			"tl": { value: strenderer.bufferL.texture },
			"tr": { value: strenderer.bufferR.texture },
 ...
 const AnaglyphStereoEffect = function (renderer, strenderer, method) {
 ...
 const SingleViewStereoEffect = function (renderer, strenderer, cross) {
	let _cross;
	this.render = function(scene, camera) {
		renderer.render(scene, _cross ? strenderer.stereoCamera.cameraR : strenderer.stereoCamera.cameraL);
	};
...
const StereoscopicEffects = function (renderer, effect) {
